...
public class TestChekCollision
{
    ...
    public void CollisionsFoundTest()
    {
        ...
        obj1.Setup(x => x.get_Property("Velocity")).Returns(new Vector(It.IsAny<int>(), It.IsAny<int>()));
        obj1.Setup(x => x.get_Property("Position")).Returns(new Vector(It.IsAny<int>(), It.IsAny<int>()));
        obj2.Setup(x => x.get_Property("Velocity")).Returns(new Vector(It.IsAny<int>(), It.IsAny<int>()));
        obj2.Setup(x => x.get_Property("Position")).Returns(new Vector(It.IsAny<int>(), It.IsAny<int>()));
